...
class Ui_Phonebook(object):
    ...
    def setupUi(self, Phonebook, connection):
        ...
        Phonebook.resize(900, 600)
        Phonebook.setMinimumSize(QtCore.QSize(1000, 600))
        Phonebook.setMaximumSize(QtCore.QSize(1000, 600))
        Phonebook.setWindowIcon(QtGui.QIcon('./icons/phonebook.png'))
        ...
        self.contact_frame.setMinimumSize(QtCore.QSize(420, 0))
        self.contact_frame.setMaximumSize(QtCore.QSize(420, 16777215))
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 400, 490))
...
"background-color: green;")
    ...
    def retranslateUi(self, Phonebook):
        ...
        self.gender.setText(_translate("Phonebook", "Gender: unknown"))
